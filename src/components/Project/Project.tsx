        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
              Built a full-stack bookstore application using the MERN stack, enabling complete CRUD operations for book records. Features include dynamic forms, real-time updates, and a responsive UI. Ensured efficient data handling with RESTful APIs and MongoDB for persistent storage.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p> Developed a responsive weather application with a FastAPI backend, integrating a third-party Weather API to display real-time data and a 7-day forecast. Implemented location-based search and deployed using GitHub Pages with automated CI/CD via GitHub Actions. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Python</li> <li>HTML</li> <li>CSS</li> <li>JavaScript</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
              Built a predictive model using Python to detect cervical cancer early, based on clinical and behavioral data. Applied and evaluated ML algorithms including Logistic Regression, Decision Trees, and Random Forest—achieving the best results with Random Forest. Focused on real-world datasets, data preprocessing, and model accuracy comparison.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/MallikarjunaGogu7/TaskManagemerApp" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>TaskFlow: Task Management App for Productivity & Organization</h3>
              <p>Developed a responsive task management application to streamline daily workflows with smart filtering, deadline tracking, and real-time notifications. Integrated a mock backend using JSON Server, with seamless API handling via Axios. Features include priority categorization, CRUD operations, and a polished UI built with React and Bootstrap Icons.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/MallikarjunaGogu7/RecipeSearch" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://recipe-searchg.netlify.app/" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              ...
              <p>Developed a responsive React app for real-time recipe search with debounced input, auto-suggestions, and detailed recipe views. Optimized performance by limiting API calls with a 500ms debounce and implemented error handling for a smooth user experience.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React.js</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/MallikarjunaGogu7/5-Star-Rating" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://5starrating.netlify.app/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              ...
              <p>
                Built a reusable and interactive 5-star rating component in React with real-time feedback, hover previews, and dynamic UI rendering. Designed for scalability and smooth user experience using state management and clean component structure.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
